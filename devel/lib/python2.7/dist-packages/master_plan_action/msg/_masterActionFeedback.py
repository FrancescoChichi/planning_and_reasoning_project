...
"""autogenerated by genpy from master_plan_action/masterActionFeedback.msg. Do not edit."""
import sys
...
class masterActionFeedback(genpy.Message):
  _md5sum = "3ba1c70991d7d5ca53ace429c1f179e7"
  _type = "master_plan_action/masterActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','master_plan_action/masterFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(masterActionFeedback, self).__init__(*args, **kwds)
      ...
      if self.feedback is None:
        self.feedback = master_plan_action.msg.masterFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = master_plan_action.msg.masterFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.pack('<I%ss'%length, length, _x))
      buff.write(_get_struct_d().pack(self.feedback.goal))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.feedback.goal,) = _get_struct_d().unpack(str[start:end])
      return self
