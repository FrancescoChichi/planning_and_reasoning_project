...
"""autogenerated by genpy from pddl_msgs/PDDLPlannerActionFeedback.msg. Do not edit."""
import sys
...
class PDDLPlannerActionFeedback(genpy.Message):
  _md5sum = "aae20e09065c3809e8a8e87c4c8953fd"
  _type = "pddl_msgs/PDDLPlannerActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','pddl_msgs/PDDLPlannerFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(PDDLPlannerActionFeedback, self).__init__(*args, **kwds)
      ...
      if self.feedback is None:
        self.feedback = pddl_msgs.msg.PDDLPlannerFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = pddl_msgs.msg.PDDLPlannerFeedback()
