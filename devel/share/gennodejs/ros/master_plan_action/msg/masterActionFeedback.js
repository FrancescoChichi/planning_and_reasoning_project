...
let masterFeedback = require('./masterFeedback.js');
let actionlib_msgs = _finder('actionlib_msgs');
let std_msgs = _finder('std_msgs');

//-----------------------------------------------------------

class masterActionFeedback {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('feedback')) {
        ...
        this.feedback = new masterFeedback();
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = masterFeedback.serialize(obj.feedback, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new masterActionFeedback(null);
    ...
    data.feedback = masterFeedback.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new masterActionFeedback(null);
    ...
    if (msg.feedback !== undefined) {
      resolved.feedback = masterFeedback.Resolve(msg.feedback)
    }
    else {
      resolved.feedback = new masterFeedback()
    }
...
module.exports = masterActionFeedback;
