...
let masterGoal = require('./masterGoal.js');
let actionlib_msgs = _finder('actionlib_msgs');
let std_msgs = _finder('std_msgs');

//-----------------------------------------------------------

class masterActionGoal {
  constructor(initObj={}) {
    if (initObj === null) {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = masterGoal.serialize(obj.goal, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new masterActionGoal(null);
    ...
    if (msg.goal !== undefined) {
      resolved.goal = masterGoal.Resolve(msg.goal)
    }
    else {
      resolved.goal = new masterGoal()
    }
...
module.exports = masterActionGoal;
